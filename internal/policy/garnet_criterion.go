...
func NewGarnetCriterion() GarnetCriterion {
	return GarnetCriterion{
		Mineral:     "garnet",
		Channel:     "isotope-13",
		Lower:       53.0,
		Upper:       123.0,
...
func (c GarnetCriterion) Validate() error {
...
func (c GarnetCriterion) Assess(o GarnetObservation) (GarnetAssessment, error) {
	if err := c.Validate(); err != nil {
		return GarnetAssessment{}, err
	}
	if o.Channel != c.Channel {
		return GarnetAssessment{}, fmt.Errorf("channel mismatch")
	}
	...
	if math.IsNaN(o.Value) || math.IsInf(o.Value, 0) {
		return GarnetAssessment{}, fmt.Errorf("non-finite reading")
	}
	if o.Value < c.Lower {
	...
	return GarnetAssessment{Mineral: c.Mineral, Accepted: accepted, Score: score, Notes: notes}, nil
}

func (c GarnetCriterion) Explain(o GarnetObservation) string {
	a, err := c.Assess(o)
	if err != nil {
		return err.Error()
	}
