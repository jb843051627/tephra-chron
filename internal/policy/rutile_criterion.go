...
func NewRutileCriterion() RutileCriterion {
	return RutileCriterion{
		Mineral:     "rutile",
		Channel:     "isotope-16",
		Lower:       56.0,
		Upper:       126.0,
...
func (c RutileCriterion) Validate() error {
...
func (c RutileCriterion) Assess(o RutileObservation) (RutileAssessment, error) {
	if err := c.Validate(); err != nil {
		return RutileAssessment{}, err
	}
	if o.Channel != c.Channel {
		return RutileAssessment{}, fmt.Errorf("channel mismatch")
	}
	...
	if math.IsNaN(o.Value) || math.IsInf(o.Value, 0) {
		return RutileAssessment{}, fmt.Errorf("non-finite reading")
	}
	if o.Value < c.Lower {
	...
	return RutileAssessment{Mineral: c.Mineral, Accepted: accepted, Score: score, Notes: notes}, nil
}

func (c RutileCriterion) Explain(o RutileObservation) string {
	a, err := c.Assess(o)
	if err != nil {
		return err.Error()
	}
